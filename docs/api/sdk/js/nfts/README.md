...
This API reference provides descriptions for all functions regarding NFTs in Ommyochain 1.x. It is recommended that you
...
[API reference](../accounts/#swaps-in-ommyochain).
