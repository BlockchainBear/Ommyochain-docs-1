...
Ommyochain uses cryptographic primitives different from ones that are used in Ethereum. So, in order to make basic
...
Repository: <https://github.com/ommyochain-sdk/ommyochain-crypto-c>

Installation: we distribute precompiled binaries for the common platforms, which can be found [here][c_libs].

[c_libs]: https://github.com/ommyochain-sdk/ommyochain-crypto-c/releases/tag/v0.1.0
...
Repository: <https://github.com/Ommyochain/Ommyochain-docs/tree/master/sdk/ommyochain-crypto>

Installation: available via `npm` package [`ommyochain-crypto`][npm_lib].

[npm_lib]: https://www.npmjs.com/package/ommyochain-crypto
...
import { sign_musig, privateKeyFromSeed } from 'ommyochain-crypto';
...
Repository: <https://github.com/ommyochain-sdk/ommyochain-sdk-java>

Installation: available via `Maven Central` package [`zkscrypto`][java_lib].

[java_lib]: https://search.maven.org/artifact/io.ommyochain.sdk/zkscrypto
...
Repository: <https://github.com/ommyochain-sdk/ommyochain-sdk-swift>
...
- Carthage: `github "ommyochain/ommyochain-sdk/swift"`

### Example

Example could be found in the [repository][swift_example].

[swift_example]: https://github.com/ommyochain-sdk/ommyochain-sdk-swift/tree/master/ZKSyncSample

## Go

Repository: <https://github.com/ommyochain-sdk/ommyochain-sdk-go>
...
- Import github.com/ommyochain-sdk/ommyochain-sdk-go
- Download `libzkscrypto` for your platform from <https://github.com/ommyochain-sdk/ommyochain-crypto-c/releases> and put it
  into `./libs` directory.
...
import (
    ...
    "github.com/ommyochain/ommyochain-sdk/go/zkscrypto"
)
