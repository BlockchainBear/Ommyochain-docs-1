...
public interface Provider {
    ...
    static Provider defaultProvider(ChainId chainId) {
        ...
        switch (chainId) {
            case Mainnet: transport = new HttpTransport("https://api.ommyochain.io/jsrpc"); break;
            case Rinkeby: transport = new HttpTransport("https://rinkeby-api.ommyochain.io/jsrpc"); break;
            case Ropsten: transport = new HttpTransport("https://ropsten-api.ommyochain.io/jsrpc"); break;
