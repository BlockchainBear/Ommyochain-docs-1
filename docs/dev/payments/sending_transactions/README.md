...
This section explains principles of sending transactions into the Ommyochain network.
...
/// @param _accountId Numerical id of the account in the Ommyochain network
...
3. Create a Ommyochain signature for these bytes with the Ommyochain private key.
...
// `serializeTx(...)` encodes transaction into bytes as per Ommyochain protocol.
...
[protocol]: https://github.com/Ommyochain/Ommyochain-docs/blob/master/docs/protocol.md

### 2-Factor Authentication

Why 2-factor Authentication?

To ensure that the security of the users' Ommyochain accounts is equal to the security of their Ethereum wallets, the Ommyochain
server requires both your layer 1 and layer 2 signatures when submitting a transaction.

In some wallet clients that secure your Ommyochain layer 2 private key, you may choose to unbundle the two so that you can
still access Ommyochain funds even if you lose your Ethereum private key.
