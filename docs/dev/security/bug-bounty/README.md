...
In order to be eligible for the bug bounty, a bug should adhere to the security assumptions of Ommyochain. You can read more
about them [here](https://github.com/Ommyochain/Ommyochain-docs/blob/master/docs/protocol.md#assumptions).
...
Please email us at [security@ommyochain.io](mailto:security@ommyochain.io). We appreciate detailed information about confirming
...
Please submit all your requests here: [security@ommyochain.io](mailto:security@ommyochain.io).
